...
public sealed class CoreApiClientCreateConflictTests
{
    ...
    public async Task CreateTileAsync_ParsesConflictPromptFromConflictResponse()
    {
        ...
        var response = await client.CreateTileAsync(new CreateTileRequest(
            ...
            NextAction: null,
            DoneDefinition: null,
            Temporal: new CreateTileTemporalRequest(null, null, DateTimeOffset.UtcNow.ToString("O"), DateTimeOffset.UtcNow.AddHours(1).ToString("O"), null, null, null),
            Objective: null,
            Interruption: null,
            Automation: null,
            Annotation: null,
    ...
    public async Task CreateTileAsync_ParsesRecurringFixedCreateConflictPrompt()
    {
        ...
        var response = await client.CreateTileAsync(new CreateTileRequest(
            ...
            NextAction: null,
            DoneDefinition: null,
            Temporal: new CreateTileTemporalRequest(null, null, null, null, null, null, null),
