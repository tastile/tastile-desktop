# Tastile Desktop Constitution

この文書は、Tastile Desktop の開発組織における最上位 contract です。
...
Tastile Desktop の開発組織の目的は current procedure への服従ではありません。
...
`rebuildup/project-init@release-0-3-0` / `57fb4a2e5abe6f52e4fd9cb2cb88234496e47d4b`
